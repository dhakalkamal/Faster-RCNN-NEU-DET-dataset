# USAGE
# python build_scratch_records.py

# import the necessary packages
from config import scratch_config as config
...
#IMAGE_PATH = os.path.sep.join(CONFIG.BASE_PATH, IMAGES )
def main(_):
	...
	for row in rows[1:]:
		...
		p = os.path.sep.join([config.BASE_PATH, "IMAGES" , imagePath])
		b = D.get(p, [])
