# USAGE
# python predict.py --model NEU-DET/experiments/exported_model/frozen_inference_graph.pb \
# 	--labels NEU-DET/records/classes.pbtxt \
# 	--image path/to/your/test/image \
# 	--num-classes num-of your classes in the dataset 6 (in this case)
...
with model.as_default():
	with tf.Session(graph=model) as sess:
		...
		for (box, score, label) in zip(boxes, scores, labels):
			...
			if score < 0.5: # assign your own value for it
				continue
		...
		cv2.imwrite("test9_pred_custom.png", output)
		cv2.waitKey(0)
